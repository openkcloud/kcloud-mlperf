...
export MLPERF_USERNAME="${MLPERF_USERNAME:-jungwooshim}"
export MLPERF_REMOTE_DIR="${MLPERF_REMOTE_DIR:-~/MLPerf_local_test}"

# Node IPs (can be overridden)
export JW1_IP="${JW1_IP:-129.254.202.251}"
export JW2_IP="${JW2_IP:-129.254.202.252}"
export JW3_IP="${JW3_IP:-129.254.202.253}"
